"""Executive Dashboard orchestrator component."""
...
def render_executive_dashboard() -> None:
    """Render the main Executive BI page containing all components in sequence."""
    st.title("📊 Executive Business Intelligence & Club Management")
    st.write(
        "Welcome to the Executive Analytics Suite. This board provides corporate, "
        "financial, and strategic operations review for Board Members, Club Owners, and C-Suite Executives."
    )
    
    # Render all sub-components in order of requirements
    st.subheader("💡 Executive Performance Overview")
    render_executive_summary()
    st.markdown("---")
    
    st.subheader("🔑 Board KPIs & Indicators")
    ...
    st.subheader("🏢 Commercial Analytics")
    render_commercial_analytics()
    st.markdown("---")
    
    st.subheader("💰 Revenue streams breakdown")
    ...
    st.subheader("💸 Transfer Finances")
    ...
    st.subheader("🎯 Player ROI Evaluation")
    render_player_roi()
    st.markdown("---")
    ...
    st.subheader("📋 Budget Planning & Allocations")
    render_budget_planning()
    st.markdown("---")
    
    st.subheader("🛡️ Squad Valuation & Asset Distribution")
    render_squad_value()
    st.markdown("---")
    
    st.subheader("🏟️ Stadium Attendance Trends")
    render_attendance_analytics()
    st.markdown("---")
    
    st.subheader("📣 Fan Engagement & Outreach")
    render_fan_engagement()
    st.markdown("---")
    
    st.subheader("🤝 Sponsorship Portfolio Metrics")
    render_sponsorship_analysis()
    st.markdown("---")
    
    st.subheader("👕 Merchandise Sales Performance")
